            ...
            <div>
                ...
                <ul class="space-y-4 text-white/60 font-medium">
                    ...
                    <li class="flex items-center gap-3 pt-2">
                        ...
                        <a href="https://api.whatsapp.com/send/?phone=5492612592729" onclick="gtag('event','whatsapp_click',{location:'footer'})" class="hover:text-white transition-colors">+54 9 2612 59-2729</a>
                    </li>
...
<a href="https://api.whatsapp.com/send/?phone=5492612592729"
   ...
   onclick="gtag('event','whatsapp_click',{location:'floating_bubble'})"
