            ...
            ?>
                <div class="notranslate max-w-2xl mx-auto bg-white rounded-3xl shadow-sm border border-slate-200 p-10 text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 justify-center">
                        ...
                        <a href="https://api.whatsapp.com/send/?phone=5492612592729" target="_blank" onclick="gtag('event','whatsapp_click',{location:'booking_success'})" class="px-6 py-3 bg-teal text-white rounded-xl font-bold hover:bg-teal-hover transition-all flex items-center justify-center gap-2">
                ...
                <script>
                    gtag('event', 'reserva_click', {
                        booking_id: <?php echo json_encode($newReservationId); ?>,
                        room_id: <?php echo json_encode((string)$newBooking['roomId']); ?>,
                        value: <?php echo json_encode($newBooking['totalPrice']); ?>,
                        currency: 'USD'
                    });
                </script>
            <?php endif; ?>
