...
function hp_mail_booking(array $b, string $roomName, float $totalARS, int $nights, string $lang = 'en'): array
{
    ...
    $t = $isEs ? [
        ...
        'intro'     => '¡Gracias por tu reserva! Ya la tenemos registrada y nuestro equipo va a ponerse en contacto contigo a traves de nuestro numero de reserva +549 2615 372767',
        ...
        'intro'     => "Thank you for your reservation! We've got it on file and our team will be ready for you. Our team will contact you shortly by +549 2615 372767.",
